                                    ...
                                    <tr>
                                        ...
                                        @foreach($product->statuses as $status)
                                            @if ($status->status_code == 'Needs Update')
                                                <td>
                                                    <div class='needsUpdate'> {{ $status->status_code }}</div>
                                                </td>
                                            @elseif ($status->status_code == 'Marked For Deletion')
                                                <td>
                                                    <div class='markedForDeletion'> {{$status->status_code}}</div>
                                                </td>
                                            @elseif ($status->status_code == 'In Progress')
                                                <td>
                                                    <div class='inProgress'> {{$status->status_code}}</div>
                                                </td>
                                            @elseif ($status->status_code == 'Ready For Use')
                                                <td>
                                                    <div class='readyForUse'> {{$status->status_code}}</div>
                                                </td>
                                            @endif
                                        @endforeach
